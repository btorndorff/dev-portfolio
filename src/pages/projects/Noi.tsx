  ...
  return (
    <div className="flex flex-col gap-3 space-y-3">
      ...
      <p className="text-sm">
        ...
        I could understand a lot of the vietnamese I was hearing and reading, I
        was miserable at speaking it especially with correct pronopunciation and
        at natural speeds. Two lessons a week wasn't enough for me to really the
        practice I needed for speaking and moreso I just really needed more
        frequent consistent practice for output. This is where the Noi was born,
        from this need for way more speaking practice.
      </p>
